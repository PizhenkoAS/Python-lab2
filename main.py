...
class Reader:
    '''
    Объект класса Reader нужен для чтение документа.
    '''
    def __init__(self):
        pass
...
class Validator:
    '''
    Объект класса Validator нужен, что бы проводить валидицию данных и сбора статистики по невалидным данным.
    Словарь с объектами класса которые занимаються считыванием файлов.
    '''
    readers = {}
    ...
    def __init__(self, reader: object, format_data_reader : str)-> None:
        ...
        self.invalid_telephone = 0
        self.invalid_height = 0
        self.invalid_inn = 0
        self.invalid_passport_number = 0
        self.invalid_university = 0
        self.invalid_age = 0
        self.invalid_political_views = 0
        self.invalid_world_view = 0
    ...
    def valid_university(self, university: str) -> bool:
        ...
        universitys = ['Филиал Российской правовой академии',
    ...
    def valid_political_views(self, political_view: str) -> bool:
        ...
        political_views_list = ['Умеренные', 'Анархистские', 'Социалистические', 'Либеральные', 'Консервативные',
                                'Либертарианские', 'Индифферентные', 'Коммунистические']
    ...
    def valid_world_view(self, world_view: str) -> bool:
        ...
        world_views = ['Пантеизм', 'Секулярный гуманизм', 'Агностицизм', 'Деизм', 'Буддизм', 'Католицизм', 'Атеизм',
...
args.add_argument("-input", type=str, nargs="+")
args.add_argument("-output", type=str, nargs="+")
args_list = args.parse_args()
print(args_list)
path = args_list.input[0]
path_write = args_list.output[0]
reader_json = Reader()

valid = Validator(reader_json, 'json')
valid.start_validation('json', path, path_write)
print("Количество валидных записей:", valid.valid_data)
print("Количество невалидных записей:", valid.sum_invalid_data)
print("Количество невалидных записей по типам ошибок:", valid.invalid_data)
